...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={Táto práca sa zaoberá generovaním bezpečnostných politík, ktoré obmedzujú systémové volania v rámci operačného systému Linux. Výstupom tejto práce je nástroj ktorý vie transformovať zoznam systémových volaní do bezpečnostnej politiky. V tejto práci sú definované požiadavky, navrhnutá architektúra programu a popísaná testovacia metodika.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={This thesis deals with creation of security policy that limits usage of system calls in Linux. The output of this thesis is a program that transform strace output into a security policy in libseccomp. In this thesis is defined software requirements, designed architecture of the program and described testing methods. }, % abstrakt v anglickém jazyce / abstract in english

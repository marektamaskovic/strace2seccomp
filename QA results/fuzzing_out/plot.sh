...
rm -f "$2/high_freq.svg" "$2/low_freq.svg" "$2/exec_speed.svg"
...
cat <<_EOF_
set terminal svg enhanced size 1000,300 butt

set output '$2/high_freq.svg'
...
set terminal svg enhanced size 1000,200 butt
set output '$2/low_freq.svg'
...
<p>
<img src="high_freq.svg" width=1000 height=300><p>
<img src="low_freq.svg" width=1000 height=200><p>
<img src="exec_speed.svg" width=1000 height=200>
...
chmod 755 "$2"
chmod 644 "$2/high_freq.svg" "$2/low_freq.svg" "$2/exec_speed.svg" "$2/index.html"

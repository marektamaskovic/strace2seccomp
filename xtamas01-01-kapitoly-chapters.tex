...
Testing of the parameters was done manually which means by systematically picking border values
or some invalid ones and providing them as runtime arguments for the strace2seccomp tool.
It was automated with a handmande script.
...
The first issue is so critical for the correct output generator of
strace2seccomp that we can not guarantee the future of this project. However,
during the work on this bachelor thesis, there was generated a small pressure on
the upstream of libseccomp project, to merge or implement own macros for range
handling.

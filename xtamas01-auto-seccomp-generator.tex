...
\abstract[en]{This bachelor's thesis has been developed in collaboration with Red Hat, Inc.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{seccomp, libseccomp, strace, optimalizátor, zhlukovaniem C++, generátor politík}
\keywords[en]{seccomp, libseccomp, strace, optimizer, clustering, C++, policy generator}
...
\begin{document}
  ...
  % ----------------------------------------------
  \input{xtamas01-auto-seccomp-generator-01-kapitoly-chapters} % viz. obsah.tex / see obsah.tex
...
\fi
  ...
  \iftwoside
    \cleardoublepage
  \fi
  \input{xtamas01-auto-seccomp-generator-30-prilohy-appendices} % viz. prilohy.tex / see prilohy.tex
\end{document}
